  ...
  <div class="main">
    ...
    <div class="model-select">
      <n-space size="small">
        ...
        <n-select size="medium" v-model:value="selectedModel" :options="options" placement="top" placeholder="请选择AI模型" class="input-select"  @update:value="handleSelected"/>
        <n-switch
          class="input-switch"
          :round="true"
          size="large"
    ...
    <div class="input">
      ...
      <div class="input-btn fix-btn">
        <n-space justify="end" style="padding-right: 10px">
          <n-button quaternary style="background: #85a5ff" round :disabled="sendBtnStatus" @click="sendMessage">
            <template #icon>
